...
def signup():
    ...
    # ---------------------------------- cofee image  ---------------------------------------------------
    img1 = ImageTk.PhotoImage(Image.open('F:\\New Volume\\PycharmProjects\\imagess\\final3.jpg'))
...
#__________________________________________  deshboard function  ___________________________________________
def deshboard():
...
#_________________________________  function for login  user ___________________________________________________________________________
def login():
        user = user_var.get()
